...
from Practica3_2 import Practica3_2  # grc-generated hier_block
...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Practica3_2_0 = Practica3_2(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.Practica3_2_0)
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.Practica3_2_0, 0))
