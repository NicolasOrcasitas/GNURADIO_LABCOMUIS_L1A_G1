...
# Title: Modulacion PM radio
# Author: Nicolas Andres
...
class ModulacionPMradio(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulacion PM radio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacion PM radio")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPMradio")
...
def main(top_block_cls=ModulacionPMradio, options=None):
